...
```
git clone git@github.com:$USER/ux-compiler.git
```

where `$USER` is your GitHub username. Here you're copying the contents of the `ux-compiler` repository on GitHub to your computer.
